 ...
 * tags:
 *   name: SifatLaka
 *   description: Sifat Laka (Accident severity type/classification) management
 */
 ...
 *     description: Retrieve a list of all active sifat laka, ordered by name ascending.
 *     tags: [SifatLaka]
 *     responses:
 *       200:
 ...
 *     description: Retrieve a single sifat laka by its ID. Returns 404 if not found or inactive.
 *     tags: [SifatLaka]
 *     parameters:
 *       - in: path
 *         name: id
 ...
 *     description: Create a new sifat laka option. Returns 409 if a sifat laka with the same name already exists.
 *     tags: [SifatLaka]
 *     requestBody:
 *       required: true
 *       content:
 ...
 *     description: Update an existing sifat laka by ID. Returns 404 if not found, 409 if the new name conflicts with another sifat laka.
 *     tags: [SifatLaka]
 *     parameters:
 *       - in: path
 *         name: id
 ...
 *     description: Soft-delete a sifat laka by setting is_active to false. Returns 404 if not found or already inactive.
 *     tags: [SifatLaka]
 *     parameters:
 *       - in: path
 *         name: id
